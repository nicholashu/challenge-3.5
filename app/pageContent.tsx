...
const PageContent = () => {
  ...
  return (
    <div className="flex h-full items-center justify-centno bg-zinc-50 font-sans">
      <div className="flex w-full max-w-lg flex-col justify-center bg-white p-8 mx-4">
        {showCompleteScreen ? (
          <>
